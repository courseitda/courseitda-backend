...
public class CategoryPlaceController {
    ...
    public ResponseEntity<CategoryPlaceCreateResponse> createCategoryPlace(
        ...
        CategoryPlaceCreateResponse response = categoryPlaceService.createCategoryPlace(member, categoryId, request);
    ...
    public ResponseEntity<Void> deleteCategoryPlace(
        ...
        categoryPlaceService.deleteCategoryPlace(member, categoryId, categoryPlaceId);
    ...
    public ResponseEntity<CategoryPlacesResponse> readCategoryPlaces(
        ...
        CategoryPlacesResponse response = categoryPlaceService.findCategoryPlaces(member, categoryId);
