...
public interface JpaWorkspaceRepository extends JpaRepository<Workspace, Long> {
    ...
    List<Workspace> findAllByOwnerIdOrderByIdDesc(Long ownerId, Pageable pageable);

    List<Workspace> findAllByOwnerIdAndIdLessThanOrderByIdDesc(Long ownerId, Long cursor, Pageable pageable);
}
