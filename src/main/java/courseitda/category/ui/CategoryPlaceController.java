...
public class CategoryPlaceController {
    ...
    public ResponseEntity<CategoryPlaceCreateResponse> createCategoryPlace(
        ...
        CategoryPlaceCreateResponse response = categoryPlaceService.createCategoryPlace(memberAuthInfo, categoryId,
                request);
    ...
    public ResponseEntity<CategoryPlacesResponse> readCategoryPlaces(
        ...
        CategoryPlacesResponse response = categoryPlaceService.findCategoryPlaces(memberAuthInfo, categoryId);
